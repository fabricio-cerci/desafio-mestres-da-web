...
import ProductAttribute from '@modules/products/infra/typeorm/entities/ProductAttribute';
import ProductAttributeValue from '@modules/products/infra/typeorm/entities/ProductAttributeValue';
