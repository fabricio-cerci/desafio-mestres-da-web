...
describe('Update Product', () => {
  ...
  it('should be able to update a product without attribute', async () => {
  ...
  it('should be able to update a product with attribute', async () => {
    const product = await updateProductService.execute({
      productId: '88218b81-93b0-4818-a605-0b77a832ea23',
      name: 'Camisa Ricky and Morty',
      sku: 'CABKMW2',
  ...
  it('should not be able to update a product with invalid id', async () => {
    expect(
      updateProductService.execute({
        productId: '88218b81-93b0-4818-a605-0b77a832ea22',
        name: 'Camisa Ricky and Morty',
        sku: 'CABKMW2',
        description: 'CAMISA BRANCA DA BROOKSFIELD DO RICK MORTY',
        price: 40.0,
  ...
  it('should not be able to update a product without attribute and with inexistent product type', async () => {
    expect(
      updateProductService.execute({
        productId: '88218b81-93b0-4818-a605-0b77a832ea23',
        name: 'Camisa Ricky and Morty',
  ...
  it('should not be able to update a product without attribute and with inexistent brand', async () => {
    expect(
      updateProductService.execute({
        productId: '88218b81-93b0-4818-a605-0b77a832ea23',
        name: 'Camisa Ricky and Morty',
  ...
  it('should not be able to update a product without attribute with repeated sku', async () => {
    expect(
      updateProductService.execute({
        productId: '88218b81-93b0-4818-a605-0b77a832ea23',
        name: 'Camisa Ricky and Morty',
  ...
  it('should not be able to update a product without attribute and negative price', async () => {
    expect(
      updateProductService.execute({
        productId: '88218b81-93b0-4818-a605-0b77a832ea23',
        name: 'Camisa Ricky and Morty',
  ...
  it('should not be able to update a product with invalid attribute', async () => {
    expect(
      updateProductService.execute({
        productId: '88218b81-93b0-4818-a605-0b77a832ea23',
        name: 'Camisa Ricky and Morty',
  ...
  it('should not be able to update a product with incorrect product type', async () => {
    expect(
      updateProductService.execute({
        productId: '88218b81-93b0-4818-a605-0b77a832ea23',
        name: 'Camisa Ricky and Morty',
  ...
  it('should not be able to update a product with invalid attribute value', async () => {
    expect(
      updateProductService.execute({
        productId: '88218b81-93b0-4818-a605-0b77a832ea23',
        name: 'Camisa Ricky and Morty',
